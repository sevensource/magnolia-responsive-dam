...
public class ResponsiveDamTemplatingFunctions {
	...
	@Inject
	public ResponsiveDamTemplatingFunctions(ResponsiveDamModule responsiveDamModule, Imaging imaging) {
	...
	public ResponsiveDamVariation getResponsiveVariation(Node node, String variationSetName, String variationName) {
        final DamVariation variation = responsiveDamModule.getConfiguredVariation(variationSetName, variationName);
        if(variation == null) {
        ...
        return new ResponsiveDamVariation(node, variation);
	}
}
